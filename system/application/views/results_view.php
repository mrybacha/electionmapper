<?php $pollnum = (int)$poll;
$polldisplay = (($pollnum-($pollnum%10))/10)."-".($pollnum%10);
$ridingrow = $riding->row();?>
...
<title>Poll <?php echo $polldisplay;?> Results - <?php echo $ridingrow->edname." (".$year?>)</title>
	...
	<div id="wrapper">
       ...
       <div id="nav">
		...
		<div id="body" class="clear">
			<div id="content">
              <h2>Poll-by-Poll Results</h2>

				<h3>Historical Election Results for Poll <?php echo $polldisplay;?> in <?php echo $year;?></h3>
				<form method="post" action="" onsubmit="return dropdown(this.gourl)"><b>Select Poll Division:</b> <select name="gourl"><option value="">--SELECT--</option>
				...
				<h4>Polling Station Name: <?php echo $station_name;?></h4>
				...
				<p><a href="/election/results/<?php echo $year ."/". $ridingrow->fednum;?>">back</a></p>
			</div>
		</div>
	</div>
